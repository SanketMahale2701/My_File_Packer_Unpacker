...
class MyLogin extends Template implements ActionListener, Runnable
{
  JButton SUBMIT;
  ...
  MyLogin()
  {
        ...
        TopLabel.setText("My Packer Unpacker: Login");
        ...
        { 
            ...
            public void focusLost(FocusEvent e) //60
            {
                label3.setText("");
            }
        });
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==SUBMIT)
        {
            if(Validate(value1, value2) == false)
            {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this, "Short username","My Packer Unpacker",JOptionPane.ERROR_MESSAGE);
            }  //134
            if(value1.equals("MyAdmin") && value2.equals("MyAdmin"))
            {   
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this, "Number of attempts finished", "My Packer Unpacker", JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                }
...
public class MyMain  //FilePackerFrontEnd
{
